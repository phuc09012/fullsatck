...
BEGIN
    ...
    (BorrowingId, ReaderId, BookId, BookTitle, BorrowedAtUtc, DueAtUtc, ReturnedAtUtc, FineAmount, FinePaidAmount, FinePaidAtUtc, Status, UpdatedAtUtc)
    VALUES
    ('33333333-3333-3333-3333-333333333301', '11111111-1111-1111-1111-111111111201', '22222222-2222-2222-2222-222222222201', 'Clean Code', DATEADD(DAY, -2, SYSUTCDATETIME()), DATEADD(DAY, 12, SYSUTCDATETIME()), NULL, 0, 0, NULL, 1, DATEADD(DAY, -2, SYSUTCDATETIME())),
    ('33333333-3333-3333-3333-333333333302', '11111111-1111-1111-1111-111111111202', '22222222-2222-2222-2222-222222222202', 'Head First Design Patterns', DATEADD(DAY, -20, SYSUTCDATETIME()), DATEADD(DAY, -5, SYSUTCDATETIME()), NULL, 0, 0, NULL, 3, DATEADD(DAY, -20, SYSUTCDATETIME())),
    ('33333333-3333-3333-3333-333333333303', '11111111-1111-1111-1111-111111111203', '22222222-2222-2222-2222-222222222203', 'ASP.NET Core in Action', DATEADD(DAY, -14, SYSUTCDATETIME()), DATEADD(DAY, -1, SYSUTCDATETIME()), DATEADD(DAY, -1, SYSUTCDATETIME()), 0, 0, NULL, 2, DATEADD(DAY, -1, SYSUTCDATETIME()));
END
GO
